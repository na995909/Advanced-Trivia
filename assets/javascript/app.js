...
var questions_arr = [
["What was the first full length CGI movie?","A Bug's Life","Monsters Inc","Toy Story","The Lion King"],
...
function ask(){
	...
	for(var i = 1; i < arr.length; i++){
		var html = '<div><input type="radio" name="movie" onclick="answer(this);" value="'+arr[i]+'"><label style="font-size:20px;font-weight:bold;color:red" for="'+arr[i]+'">'+	
       arr[i]+	'</label></div>';
